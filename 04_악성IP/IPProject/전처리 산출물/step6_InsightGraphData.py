...
# 악성IP 많은 1~5위 국가
save_df = new_df.loc[:4]

# 파일로 저장
save_df.to_csv('./outputs/InsightGraphData.csv', index=False)

# 24.04.29 json형태로 변환하기
# csv 파일 경로
csv_file_path = './outputs/InsightGraphData.csv'
...
# txt 파일로 저장할 경로
txt_file_path = './outputs/InsightGraphData.txt'
